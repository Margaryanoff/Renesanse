...
export default function createHistoryEnhancer({
  ...
  return function historyEnhancer(createStore) {
    return (...args) => {
      ...
      const middlewareEnhancer = applyMiddleware(ensureLocationMiddleware, navigationListenerMiddleware, ...middlewares, createHistoryMiddleware(protocol), ...[...middlewares].reverse(), navigationListenerMiddleware);
