...
class StateStorage {
  ...
  read(location, key) {
    ...
    try {
      const value = window.sessionStorage.getItem(stateKey); // === null is probably sufficient.
  ...
  save(location, key, value) {
    ...
    if (value === undefined) {
      ...
      } catch (e) {// No need to handle errors here.
      }
    ...
    } catch (e) {// No need to handle errors here either. If it didn't work, it didn't
