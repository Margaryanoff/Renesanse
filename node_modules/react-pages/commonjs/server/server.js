    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return renderPage({
            url: request.url,
            origin: "".concat(request.socket.encrypted ? 'https' : 'http', "://").concat(request.headers.host),
...
function renderPage(_x5, _x6, _x7) {
  return _renderPage.apply(this, arguments);
}
function _renderPage() {
  _renderPage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref, settings, options) {
    var url, origin, headers, secure, proxy, assets, renderContent, html, stats, getLoadContext, getInitialState, cookies, _yield$render, status, content, redirect, route, time, newCookies;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          url = _ref.url, origin = _ref.origin, headers = _ref.headers;
          secure = options.secure, proxy = options.proxy, assets = options.assets, renderContent = options.renderContent, html = options.html, stats = options.stats, getLoadContext = options.getLoadContext, getInitialState = options.getInitialState;
