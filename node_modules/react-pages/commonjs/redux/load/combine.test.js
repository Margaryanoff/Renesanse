...
var _combine = require("./combine.js");
...
describe("load", function () {
  it("should filter preloaders", function () {
    ...
    // server : true
    (0, _combine.filterLoaders)(preloaders, true).should.deep.equal([[{
      load: preload_2,
      options: {
        blocking: false
      }
    ...
    (0, _combine.filterLoaders)(preloaders, false, false).should.deep.equal([[{
      load: preload_1,
      options: {
        client: true
      }
    ...
    (0, _combine.filterLoaders)(preloaders, false, true).should.deep.equal([[{
      load: preload_1,
      options: {
        client: true
      }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          promise = (0, _combine.createPromiseFromLoaders)([{
            parallel: [preload_1, preload_2]
          }, {
            parallel: [preload_3, preload_4]
          }, preload_5], function () {
