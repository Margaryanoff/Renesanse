...
var _Router = _interopRequireDefault(require("../../router/server/Router.js"));
...
function _renderOnServer() {
  _renderOnServer = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    var store, stash, codeSplit, time, pageLoadTimer, renderArgs, _renderArgs, routes, elements, meta;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          store = _ref.store, stash = _ref.stash, codeSplit = _ref.codeSplit;
          // Routing only takes a couple of milliseconds
          // const routingTimer = timer()
          // Profiling
          time = {};
          pageLoadTimer = (0, _timer["default"])();
          _context.prev = 3;
          _context.next = 6;
        ...
        case 14:
          ...
          return _context.abrupt("return", {
            ...
            content: (0, _Router["default"])(renderArgs),
            meta: meta,
            rootComponentProps: {
              store: store
            },
