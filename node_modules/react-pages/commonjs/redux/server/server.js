...
var _parseDates = require("../../parseDates.js");
var _html = require("../../server/html.js");
var _store = _interopRequireDefault(require("../store.js"));
var _Stash = _interopRequireDefault(require("../Stash.js"));
var _HttpClient = _interopRequireDefault(require("../HttpClient.js"));
var _createHistoryProtocol2 = _interopRequireDefault(require("../../router/server/createHistoryProtocol.js"));
var _getNavigationLocation = _interopRequireDefault(require("../navigation/getNavigationLocation.js"));
...
function _initialize() {
  _initialize = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(settings, _ref) {
    var proxy, cookies, headers, locales, url, origin, location, getLoadContext, getInitialState, store, httpClient, initialState, stash;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          proxy = _ref.proxy, cookies = _ref.cookies, headers = _ref.headers, locales = _ref.locales, url = _ref.url, origin = _ref.origin, location = _ref.location, getLoadContext = _ref.getLoadContext, getInitialState = _ref.getInitialState;
          // Create HTTP client (Redux action creator `http` utility)
          httpClient = (0, _HttpClient["default"])(settings, function () {
            return store;
          }, {
            proxy: proxy,
            cookies: cookies,
          ...
          initialState.navigationLocation = (0, _getNavigationLocation["default"])(location);

          // Create utility data stash.
          stash = new _Stash["default"](); // Create Redux store.
          store = (0, _store["default"])({
            initialState: initialState,
            createHistoryProtocol: function createHistoryProtocol() {
              return (0, _createHistoryProtocol2["default"])({
                url: url,
                origin: origin
              });
            },
...
function _generateJavascript(store, settings) {
  ...
  code += "<script>";
  code += "window._ReactPages_ReduxStateServerSideSnapshot = JSON.parse(".concat(JSON.stringify((0, _html.safeJsonStringify)(store.getState()))).concat(settings.parseDates ? ', JSON.dateParser' : '', ")");
  code += "</script>";
  return code;
}
...
var DEFINE_JSON_DATE_PARSER = "\nif (!JSON.dateParser) {\n\tJSON.dateParser = function(key, value) {\n\t\tif (typeof value === 'string' && /^".concat(_parseDates.IsoDatePattern, "$/.test(value)) {\n\t\t\treturn new Date(value)\n\t\t}\n\t\treturn value\n\t}\n}");
