...
var animationFrame = _interopRequireWildcard(require("dom-helpers/cjs/animationFrame.js"));
var _scrollLeft = _interopRequireDefault(require("dom-helpers/cjs/scrollLeft.js"));
var _scrollTop = _interopRequireDefault(require("dom-helpers/cjs/scrollTop.js"));
var _invariant = _interopRequireDefault(require("invariant"));
var _lifecycleEs = _interopRequireDefault(require("page-lifecycle/dist/lifecycle.es5.js"));
...
var ScrollBehavior = /*#__PURE__*/function () {
  function ScrollBehavior(_ref) {
    ...
    _defineProperty(this, "_setScrollRestoration", function () {
    ...
    _defineProperty(this, "_restoreScrollRestoration", function () {
    ...
    _defineProperty(this, "_onWindowScroll", function () {
      ...
      if (_this._windowScrollTarget) {
        var _this$_windowScrollTa = _slicedToArray(_this._windowScrollTarget, 2),
    ...
    _defineProperty(this, "_saveWindowPosition", function () {
      _this._saveWindowPositionHandle = null;
      _this._savePosition(null, window);
    });
    _defineProperty(this, "_checkWindowScrollPosition", function () {
    ...
    this._pageLifecycleListener = function (_ref3) {
    ...
    _lifecycleEs["default"].addEventListener('statechange', this._pageLifecycleListener);
  }
  _createClass(ScrollBehavior, [{
    key: "registerElement",
    value: function registerElement(key, element, shouldUpdateScroll, context) {
      var _this2 = this;
      (0, _invariant["default"])(!this._scrollElements[key], 'ScrollBehavior: There is already an element registered for `%s`.', key);
    ...
    value: function unregisterElement(key) {
      (0, _invariant["default"])(this._scrollElements[key], 'ScrollBehavior: There is no element registered for `%s`.', key);
    ...
    key: "updateScroll",
    value: function updateScroll(prevContext, context) {
      var _this3 = this;
    ...
    value: function stop() {
      ...
      _lifecycleEs["default"].removeEventListener('statechange', this._pageLifecycleListener);
      this._removeNavigationListener();
    }
  }, {
    key: "startIgnoringScrollEvents",
    value: function startIgnoringScrollEvents() {
      this._ignoreScrollEvents = true;
    }
  }, {
    key: "stopIgnoringScrollEvents",
    value: function stopIgnoringScrollEvents() {
      this._ignoreScrollEvents = false;
    }
  }, {
    key: "_cancelCheckWindowScroll",
    value: function _cancelCheckWindowScroll() {
      animationFrame.cancel(this._checkWindowScrollHandle);
      this._checkWindowScrollHandle = null;
    }
  }, {
    key: "_saveElementPosition",
    value: function _saveElementPosition(key) {
    ...
    key: "_savePosition",
    value: function _savePosition(key, element) {
      this._stateStorage.save(this._getCurrentLocation(), key, [(0, _scrollLeft["default"])(element), (0, _scrollTop["default"])(element)]);
    }
  }, {
    key: "_updateWindowScroll",
    value: function _updateWindowScroll(prevContext, context) {
    ...
    key: "_updateElementScroll",
    value: function _updateElementScroll(key, prevContext, context) {
    ...
    key: "_getDefaultScrollTarget",
    value: function _getDefaultScrollTarget(location) {
    ...
    key: "_getScrollTarget",
    value: function _getScrollTarget(key, shouldUpdateScroll, prevContext, context) {
    ...
    key: "_getSavedScrollTarget",
    value: function _getSavedScrollTarget(key, location) {
    ...
    value: function scrollToTarget(element, target) {
      ...
      var _target = target,
        _target2 = _slicedToArray(_target, 2),
        left = _target2[0],
        top = _target2[1];
